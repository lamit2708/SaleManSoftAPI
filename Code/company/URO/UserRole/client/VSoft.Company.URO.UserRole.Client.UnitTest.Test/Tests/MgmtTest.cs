...
using VSoft.Company.URO.UserRole.Api.UnitTest.Client.Bases;
using VSoft.Company.URO.UserRole.Business.Dto.Request;
using VSoft.Company.URO.UserRole.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.URO.UserRole.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateAsync(string name, string desc)
    {
       ...
       // dto.FullName = name;
        ...
        await TestCreateAsync(new UserRoleInsertDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new UserRoleInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateAsync(int id, string note, string description)
    {
        ...
        await TestUpdateAsync(new UserRoleUpdateDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new UserRoleUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteAsync(new UserRoleDeleteDtoRequest()
        {
            Id = id,
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new UserRoleDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, long id1, long id2)
    {
        ...
        await TestSaveRangeAsync(new UserRoleSaveRangeDtoRequest()
        {
