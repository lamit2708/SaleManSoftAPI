...
using Model = VSoft.Company.PRF.ProductFeature.Data.Entity.Models.MProductFeatureEntity;

namespace VSoft.Company.PRF.ProductFeature.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<ProductFeatureDbContext, IProductFeatureRepository, Model>
{
    ...
    {
        await RunTest("TestAddProductFeature", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateProductFeature", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelProductFeature", async (r, l) =>
        {
