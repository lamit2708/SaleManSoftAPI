...
using VSoft.Company.PRF.ProductFeature.Repository.Efc.Services;

namespace VSoft.Company.PRF.ProductFeature.Repository.Efc.Provider.Services;

public class EfcProductFeatureRepository : EFcRepositoryEntityMgmtId<ProductFeatureDbContext, MProductFeatureEntity, int>, IProductFeatureRepositoryEfc
{

    public EfcProductFeatureRepository(ProductFeatureDbContext dbContext) : base(dbContext, dbContext.Items)
    {
    ...
    public async Task<PagedList<MProductFeatureEntity>> GetTableByKeySearchAsync(string keySearch, PagingParameters pagParams)
    {
        IQueryable<MProductFeatureEntity>? query;
        ...
        var data = await query
            ...
            .ToListAsync();
        return new PagedList<MProductFeatureEntity>(data, count, pagParams.PageNumber, pagParams.PageSize);
    }
}
