...
using VSoft.Company.PRF.ProductFeature.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.PRF.ProductFeature.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestProductFeatureTest : TestMgmtEntities
{
