...
namespace VSoft.Company.PRF.ProductFeature.Data.Migrate.Test.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductFeatureInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_ProductFeatureInfo_TO_ProductFeature",
                table: "ProductFeature",
                column: "ProductFeatureInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_ProductFeature",
                table: "ProductFeature",
                column: "PriorityId");
