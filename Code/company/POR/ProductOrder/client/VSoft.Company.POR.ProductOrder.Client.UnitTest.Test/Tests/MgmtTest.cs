...
using VSoft.Company.POR.ProductOrder.Api.UnitTest.Client.Bases;
using VSoft.Company.POR.ProductOrder.Business.Dto.Request;
using VSoft.Company.POR.ProductOrder.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.POR.ProductOrder.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateAsync(string name, string desc)
    {
        ...
        await TestCreateAsync(new ProductOrderInsertDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new ProductOrderInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateAsync(int id, string note, string description)
    {
        ...
        await TestUpdateAsync(new ProductOrderUpdateDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new ProductOrderUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteAsync(new ProductOrderDeleteDtoRequest()
        {
            Id = id,
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new ProductOrderDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, int id1, int id2)
    {
        ...
        await TestSaveRangeAsync(new ProductOrderSaveRangeDtoRequest()
        {
