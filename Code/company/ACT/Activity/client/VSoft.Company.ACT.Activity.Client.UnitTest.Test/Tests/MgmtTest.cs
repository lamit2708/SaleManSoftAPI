...
using VSoft.Company.ACT.Activity.Api.UnitTest.Client.Bases;
using VSoft.Company.ACT.Activity.Business.Dto.Request;
using VSoft.Company.ACT.Activity.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.ACT.Activity.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateAsync(string name, string desc)
    {
        ...
        await TestCreateAsync(new ActivityInsertDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new ActivityInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateAsync(int id, string note, string description)
    {
        ...
        await TestUpdateAsync(new ActivityUpdateDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new ActivityUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteAsync(new ActivityDeleteDtoRequest()
        {
            Id = id,
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new ActivityDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, int id1, int id2)
    {
        ...
        await TestSaveRangeAsync(new ActivitySaveRangeDtoRequest()
        {
