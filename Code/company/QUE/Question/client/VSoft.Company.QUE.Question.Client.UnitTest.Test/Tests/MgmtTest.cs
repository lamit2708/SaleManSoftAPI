...
using VSoft.Company.QUE.Question.Api.UnitTest.Client.Bases;
using VSoft.Company.QUE.Question.Business.Dto.Request;
using VSoft.Company.QUE.Question.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.QUE.Question.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateAsync(string name, string desc)
    {
       ...
       // dto.FullName = name;
        ...
        await TestCreateAsync(new QuestionInsertDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new QuestionInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateAsync(int id, string note, string description)
    {
        ...
        await TestUpdateAsync(new QuestionUpdateDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new QuestionUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteAsync(new QuestionDeleteDtoRequest()
        {
            Id = id,
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new QuestionDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, long id1, long id2)
    {
        ...
        await TestSaveRangeAsync(new QuestionSaveRangeDtoRequest()
        {
