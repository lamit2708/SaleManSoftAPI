...
using VSoft.Company.PRO.Product.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.PRO.Product.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new ProductInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new ProductUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new ProductDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, int id1, int id2)
    {
        ...
        await TestSaveRangeAsync(new ProductSaveRangeDtoRequest()
        {
