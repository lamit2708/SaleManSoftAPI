...
namespace VSoft.Company.PRO.Product.Api.UnitTest.Client.Real
{
    ...
    public class UnitTest1 : TestMgmtClient
    {
        ...
        [TestMethod]
        [DataRow(60, "Hệ thống quản lý nhân viên, chấm công 111", 200000000, 1, 1, "Hệ thống giúp thu thập, giải quyết, lưu trữ, truyền đạt, phân phối các thông tin có liên quan đến nguồn nhân lực trong công ty để hỗ trợ cho việc ra quyết định.")]
