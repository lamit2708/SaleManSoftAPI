...
namespace VSoft.Company.VDT.VDealTag.Api.UnitTest.Client.Bases
{
    public class TestMgmtClient : ApiClientTest<Model>
    {
        ...
        protected async Task TestCreateAsync(VDealTagInsertDtoRequest request)
        {
        ...
        protected async Task TestCreateRangeAsync(VDealTagInsertRangeDtoRequest request)
        {
        ...
        protected async Task TestUpdateAsync(VDealTagUpdateDtoRequest request)
        {
        ...
        protected async Task TestUpdateRangeAsync(VDealTagUpdateRangeDtoRequest request)
        {
        ...
        protected async Task TestDeleteAsync(VDealTagDeleteDtoRequest request)
        {
        ...
        protected async Task TestDeleteRangeAsync(VDealTagDeleteRangeDtoRequest request)
        {
        ...
        protected async Task TestSaveRangeAsync(VDealTagSaveRangeDtoRequest request)
        {
