...
using VSoft.Company.ROL.Role.Api.UnitTest.Client.Bases;
using VSoft.Company.ROL.Role.Business.Dto.Request;
using VSoft.Company.ROL.Role.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.ROL.Role.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new RoleInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new RoleUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new RoleDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, int id1, int id2)
    {
        ...
        await TestSaveRangeAsync(new RoleSaveRangeDtoRequest()
        {
