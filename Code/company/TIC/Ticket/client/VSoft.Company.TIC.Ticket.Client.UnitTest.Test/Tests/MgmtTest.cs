...
using VSoft.Company.TIC.Ticket.Api.UnitTest.Client.Bases;
using VSoft.Company.TIC.Ticket.Business.Dto.Request;
using VSoft.Company.TIC.Ticket.Client.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.TIC.Ticket.Client.UnitTest.Test.Tests;
...
public class MgmtTest : TestMgmtClient
{
    ...
    public async Task CreateAsync(string name, string desc)
    {
       ...
       // dto.FullName = name;
        ...
        await TestCreateAsync(new TicketInsertDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task CreateRangeAsync(string note1, string note2, string note3)
    {
        ...
        await TestCreateRangeAsync(new TicketInsertRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
    ...
    public async Task UpdateAsync(int id, string note, string description)
    {
        ...
        await TestUpdateAsync(new TicketUpdateDtoRequest()
        {
            Data = dto
        });
    }
    ...
    public async Task UpdateRangeAsync(string data1, string data2, string data3)
    {
        ...
        await TestUpdateRangeAsync(new TicketUpdateRangeDtoRequest()
        {
            Data = new[] { d1, d2, d3 }
        });
    }
    ...
    {
        await TestDeleteAsync(new TicketDeleteDtoRequest()
        {
            Id = id,
        });
    }
    ...
    {
        await TestDeleteRangeAsync(new TicketDeleteRangeDtoRequest()
        {
            Ids = new[] { id1, id2, id3 },
        });
    }
    ...
    public async Task SaveRangeAsync(string note1, string note2, string data1, string data2, string data3, int id1, int id2)
    {
        ...
        await TestSaveRangeAsync(new TicketSaveRangeDtoRequest()
        {
